...
public class hibSkillsDAOImpl implements SkillsDAO{
    ...
    private void resultProcessing(String sql) throws SQLException {
        ResultSet resultSetSkills = hibConnectDAOImpl.selectRecord(sql);
