...
public class hibDevelopersDAOImpl implements DevelopersDAO {
    ...
    public void updateElement(int dev_id, String dev_name, int dev_salary) throws SQLException {
        ...
        hibConnectDAOImpl.changeRecord(sql, dev_id, dev_name, dev_salary);
    }
    ...
    private void resultProcessing(String sql) throws SQLException {
        ResultSet resultSetDevelopers = hibConnectDAOImpl.selectRecord(sql);
