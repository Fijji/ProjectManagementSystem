...
public class hibCompanyDAOImpl implements CompanyDAO {
    ...
    public void createElement(int com_id, String com_name) throws SQLException {
        ...
        hibConnectDAOImpl.addRecord(sql, com_id, com_name);
    }
    ...
    private void resultProcessing(String sql) throws SQLException {
        ResultSet resultSetCompanies = hibConnectDAOImpl.selectRecord(sql);
