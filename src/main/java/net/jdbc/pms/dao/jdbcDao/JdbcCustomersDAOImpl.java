...
public class JdbcCustomersDAOImpl implements CustomersDAO {
    ...
    public void updateElement(int customer_id, String customer_name) throws SQLException {
        ...
        JdbcConnectDAOImpl.changeRecord(sql, customer_id, customer_name);
    }

    public void deleteElement(int customer_id) throws SQLException {
        String sql = "DELETE FROM Customers WHERE customer_id = ?";
        JdbcConnectDAOImpl.changeRecord(sql, customer_id);
    }
    ...
    public void createElement(int customer_id, String customer_name) throws SQLException {
        ...
        JdbcConnectDAOImpl.addRecord(sql, customer_id, customer_name);
    }
    ...
    private void resultProcessing(String sql) throws SQLException {
        ResultSet resultSetCustomers = JdbcConnectDAOImpl.selectRecord(sql);
